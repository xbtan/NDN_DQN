...
if __name__ == "__main__":
    ...
    for i_episede in range(MAX_EPISODES):
        ...
        while not done:
            ...
            s_ = np.array([Observation_Data[0], Observation_Data[1], Observation_Data[2],Observation_Data[3],Observation_Data[4]])
            done=Observation_Data[5]
            Episode_Step+=1
            #if Episode_Step>=200:
            #    done=1
         
            r = np.log(Observation_Data[6]/Observation_Data[7])*80-Observation_Data[2]*Observation_Data[2]*2-Observation_Data[3]*Observation_Data[3]
            ...
            with open(Train_Log_Path, 'a') as TrainLog:
                TrainLog.write('%-1d'%a+'   '+'%-4d'%Observation_Data[0]+'   '+'%-4d'%Observation_Data[1]+'   '+'%-10f'%Observation_Data[2]+'   '+'%-10f'%Observation_Data[3]+'   '+'%-10f'%reward1+'   '+'%-10f'%reward2+'   '+'%-10f'%reward3+'   '+'%-10f'%reward4+'   '+'%-1d'%done+' '+'%-4d'%(i+1)+'\n')
                TrainLog.close()
            ...
            with open(Action_Path, 'a') as ActionLog:
                ActionLog.write(str(a[0])+'   '+str(done))
                ActionLog.close()
