...
def TrainOnLineGraph():
    ...
    checkpoint = tf.train.get_checkpoint_state("../Graph/Graph2/1")
    ...
    for i_episode in range(options.MAX_EPISODE):   
        ...
        while not done:
            ...
            reward=np.log(Observation_Data[6]/Observation_Data[7])*70-(Observation_Data[2]+1)*(Observation_Data[2]+1)*8-Observation_Data[3]*Observation_Data[3]*3
             
             
            #reward=np.log(Observation_Data[6]/Observation_Data[7])*70-Observation_Data[2]*Observation_Data[2]*7-Observation_Data[3]*Observation_Data[3]*3
            ...
            reward1=np.log(Observation_Data[6]/Observation_Data[7])*80
        ...
        if (i_episode+1)%1==0:
            os.makedirs('../Graph/Graph2/'+str(i_episode+1))
            saver.save(sess, '../Graph/Graph2/' + str(i_episode+1) + '/' + 'dqn',global_step = i_episode+1)   
            print("Graph_saved !")
