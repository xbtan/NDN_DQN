...
def TrainOnLineGraph():
    ...
    checkpoint = tf.train.get_checkpoint_state("../Graph/Graph2/2")
    ...
    for i_episode in range(options.MAX_EPISODE):   
        ...
        while not done:
            ...
            reward=(Observation_Data[6]/Observation_Data[7])*100-Observation_Data[2]*Observation_Data[2]*4-Observation_Data[3]*Observation_Data[3]*2
            #根本用不上
            ...
            reward1=(Observation_Data[6]/Observation_Data[7])*100
            reward2=Observation_Data[2]*Observation_Data[2]*4
            reward3=Observation_Data[3]*Observation_Data[3]*2
            reward4=reward
