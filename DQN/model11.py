...
def get_options():
    ...
    parser.add_argument('--MAX_EPISODE', type=int, default=2000,   #2000
    ...
    parser.add_argument('--INIT_EPS', type=float, default=1e-5,    #1.0
                        help='initial probability for randomly sampling action')
    parser.add_argument('--FINAL_EPS', type=float, default=1e-5,    #1e-5
                        help='finial probability for randomly sampling action')
    parser.add_argument('--EPS_DECAY', type=float, default=0.95,    #0.95
                        help='epsilon decay rate')
    parser.add_argument('--EPS_ANNEAL_STEPS', type=int, default=10,   #10
